...
// Route::get('api/broadcast', [BroadcastController::class, 'index'])
//     ->middleware(['auth', 'verified'])
//     ->name('api/broadcast.index');

// Route::post('api/broadcast/send', [BroadcastController::class, 'send'])
//     ->middleware(['auth', 'verified'])
//     ->name('api/broadcast.send');
